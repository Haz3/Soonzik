...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post :create, concert: { address_id: @concert.address_id, planification: @concert.planification, url: @concert.url, user_id: @concert.user_id }
    end
  ...
  test "should update concert" do
    patch :update, id: @concert, concert: { address_id: @concert.address_id, planification: @concert.planification, url: @concert.url, user_id: @concert.user_id }
    assert_redirected_to concert_path(assigns(:concert))
  end
