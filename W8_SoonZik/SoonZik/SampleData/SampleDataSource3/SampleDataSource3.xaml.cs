...
namespace Blend.SampleData.SampleDataSource3
{
	using System; 
...
// la constante de compilation conditionnelle DISABLE_SAMPLE_DATA et désactiver les données échantillons lors de l'exécution.
	...
	public class SampleDataSource3 : INotifyPropertyChanged
	{
		...
		public SampleDataSource3()
		{
			try
			{
				Uri resourceUri = new Uri("ms-appx:/SampleData/SampleDataSource3/SampleDataSource3.xaml", UriKind.RelativeOrAbsolute);
