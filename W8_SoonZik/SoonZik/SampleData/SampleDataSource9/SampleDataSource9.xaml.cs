...
namespace Blend.SampleData.SampleDataSource9
{
	using System; 
...
// la constante de compilation conditionnelle DISABLE_SAMPLE_DATA et désactiver les données échantillons lors de l'exécution.
	...
	internal class SampleDataSource9 { }
#else

	public class SampleDataSource9 : INotifyPropertyChanged
	{
		...
		public SampleDataSource9()
		{
			try
			{
				Uri resourceUri = new Uri("ms-appx:/SampleData/SampleDataSource9/SampleDataSource9.xaml", UriKind.RelativeOrAbsolute);
