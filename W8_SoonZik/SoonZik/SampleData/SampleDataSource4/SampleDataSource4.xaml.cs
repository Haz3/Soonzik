...
namespace Blend.SampleData.SampleDataSource4
{
	using System; 
...
// la constante de compilation conditionnelle DISABLE_SAMPLE_DATA et désactiver les données échantillons lors de l'exécution.
	...
	internal class SampleDataSource4 { }
#else

	public class SampleDataSource4 : INotifyPropertyChanged
	{
		...
		public SampleDataSource4()
		{
			try
			{
				Uri resourceUri = new Uri("ms-appx:/SampleData/SampleDataSource4/SampleDataSource4.xaml", UriKind.RelativeOrAbsolute);
