...
namespace Blend.SampleData.SampleDataSource6
{
	using System; 
...
// la constante de compilation conditionnelle DISABLE_SAMPLE_DATA et désactiver les données échantillons lors de l'exécution.
	...
	internal class SampleDataSource6 { }
#else

	public class SampleDataSource6 : INotifyPropertyChanged
	{
		...
		public SampleDataSource6()
		{
			try
			{
				Uri resourceUri = new Uri("ms-appx:/SampleData/SampleDataSource6/SampleDataSource6.xaml", UriKind.RelativeOrAbsolute);
