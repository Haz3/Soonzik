...
namespace Blend.SampleData.SampleDataSource5
{
	using System; 
...
// la constante de compilation conditionnelle DISABLE_SAMPLE_DATA et désactiver les données échantillons lors de l'exécution.
	...
	internal class SampleDataSource5 { }
#else

	public class SampleDataSource5 : INotifyPropertyChanged
	{
		...
		public SampleDataSource5()
		{
			try
			{
				Uri resourceUri = new Uri("ms-appx:/SampleData/SampleDataSource5/SampleDataSource5.xaml", UriKind.RelativeOrAbsolute);
