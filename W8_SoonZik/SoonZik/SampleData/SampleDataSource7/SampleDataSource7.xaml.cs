...
namespace Blend.SampleData.SampleDataSource7
{
	using System; 
...
// la constante de compilation conditionnelle DISABLE_SAMPLE_DATA et désactiver les données échantillons lors de l'exécution.
	...
	internal class SampleDataSource7 { }
#else

	public class SampleDataSource7 : INotifyPropertyChanged
	{
		...
		public SampleDataSource7()
		{
			try
			{
				Uri resourceUri = new Uri("ms-appx:/SampleData/SampleDataSource7/SampleDataSource7.xaml", UriKind.RelativeOrAbsolute);
