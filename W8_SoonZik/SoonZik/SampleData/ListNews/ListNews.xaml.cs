...
namespace Blend.SampleData.ListNews
{
	using System; 
...
// la constante de compilation conditionnelle DISABLE_SAMPLE_DATA et désactiver les données échantillons lors de l'exécution.
	...
	public class ListNews : INotifyPropertyChanged
	{
		...
		public ListNews()
		{
			try
			{
				Uri resourceUri = new Uri("ms-appx:/SampleData/ListNews/ListNews.xaml", UriKind.RelativeOrAbsolute);
