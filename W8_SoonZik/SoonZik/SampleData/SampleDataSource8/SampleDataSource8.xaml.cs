...
namespace Blend.SampleData.SampleDataSource8
{
	using System; 
...
// la constante de compilation conditionnelle DISABLE_SAMPLE_DATA et désactiver les données échantillons lors de l'exécution.
	...
	internal class SampleDataSource8 { }
#else

	public class SampleDataSource8 : INotifyPropertyChanged
	{
		...
		public SampleDataSource8()
		{
			try
			{
				Uri resourceUri = new Uri("ms-appx:/SampleData/SampleDataSource8/SampleDataSource8.xaml", UriKind.RelativeOrAbsolute);
