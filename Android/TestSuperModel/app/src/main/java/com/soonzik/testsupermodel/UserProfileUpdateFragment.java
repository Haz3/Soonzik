...
public class UserProfileUpdateFragment extends Fragment {
    ...
    private String redirectClass = "com.soonzik.testsupermodel.UserProfileFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        updateValidateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ActiveRecord.update("User", params, ActiveRecord.currentUser.getId(), new ActiveRecord.OnJSONResponseCallback() {
                        @Override
                        public void onJSONResponse(boolean success, Object response, Class<?> classT) throws InvocationTargetException, NoSuchMethodException, java.lang.InstantiationException, IllegalAccessException {
