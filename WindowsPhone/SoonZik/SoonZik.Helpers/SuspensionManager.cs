...
namespace SoonZik.Helpers
{
    public sealed class SuspensionManager
    {
        ...
        private static readonly DependencyProperty _frameSessionStateKeyProperty =
            DependencyProperty.RegisterAttached("_FrameSessionStateKey", typeof (String), typeof (SuspensionManager),
                null);

        private static readonly DependencyProperty _frameSessionBaseKeyProperty =
            DependencyProperty.RegisterAttached("_FrameSessionBaseKeyParams", typeof (String),
                typeof (SuspensionManager), null);

        private static readonly DependencyProperty _frameSessionStateProperty =
        ...
        public static async Task RestoreAsync(String sessionBaseKey = null)
        {
            ...
            try
            {
                ...
                foreach (var weakFrameReference in _registeredFrames)
                {
                    Frame frame;
                    if (weakFrameReference.TryGetTarget(out frame) &&
                        (string) frame.GetValue(_frameSessionBaseKeyProperty) == sessionBaseKey)
                    {
